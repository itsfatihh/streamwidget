...
export const WIDGETS_LIST: WidgetDef[] = [
  ...
  },
  {
    ...
    category: 'IRL',
    description: 'Dış mekan yayınları için modüler LIVE rozeti, saat, konum, hava durumu ve canlı pil durumu.',
    fields: [
      { name: 'channel', label: 'Kick Kanal Adı (Komutlar için)', type: 'text', defaultValue: 'itsfatih', placeholder: 'Kanal adı' },
      ...
      { name: 'location', label: 'Konum (Boşsa otomatik, chaten !konum ile de değişir)', type: 'text', defaultValue: 'auto', placeholder: 'auto (veya Şehir Adı)' },
      ...
      { name: 'showBattery', label: 'Cihaz Bataryası Gösterilsin mi?', type: 'select', defaultValue: 'true', options: [{ label: 'Evet (Göster)', value: 'true' }, { label: 'Hayır (Gizle)', value: 'false' }] },
      { name: 'scale', label: 'Boyut (%)', type: 'select', defaultValue: '100', options: [{ label: 'Normal (%100)', value: '100' }, { label: 'Büyük (%125)', value: '125' }] },
    ],
  },
  {
